...
<div class="spt-w-full  ">
    ...
    <div class="spt-h-[444px] spt-w-full spt-max-w-full spt-flex spt-grow-0  spt-justify-center spt-items-center spt-overflow-hidden " >
        <div on:click={next} class="spt-h-full spt-resize  spt-inline-flex spt-relative" style="width:{max_size+"px"}; min-width:{max_size+"px"}; ">
           <PopularPost left={all_x[0]} selected={selected==0} {limit} image={browser.runtime.getURL("src/assets/test_shit/test2.png")}/>
           <PopularPost left={all_x[1]} selected={selected==1} {limit} image={browser.runtime.getURL("src/assets/test_shit/test1.png")}/>
           <PopularPost left={all_x[2]} selected={selected==2} {limit} image={browser.runtime.getURL("src/assets/test_shit/test3.png")}/>
           <PopularPost left={all_x[3]} selected={selected==3} {limit} image={browser.runtime.getURL("src/assets/test_shit/test2.png")}/>
           <PopularPost left={all_x[4]} selected={selected==4} {limit} image={browser.runtime.getURL("src/assets/test_shit/test1.png")}/>
        </div>
