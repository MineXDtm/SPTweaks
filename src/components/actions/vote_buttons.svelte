...
<div class="spt-flex-col spt-space-y-[6px]">
    ...
    <div on:click={upvote} class="spt-group vote_button_main  {vote == 1? 'spt-bg-[#4D4DB1]': 'spt-bg-[#3D3D3D]'} spt-cursor-pointer ">
